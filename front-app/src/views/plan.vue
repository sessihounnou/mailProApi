...
<main>
    ...
    <nav x-data="{ isOpen: false }" class="container mx-auto p-6 lg:flex lg:items-center lg:justify-between">
        ...
        <div>
            <a class="text-2xl font-bold text-gray-800 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 lg:text-3xl" href="#">Biris .</a>
        </div>
        ...
        <div class="lg:-px-8 flex flex-col space-y-4 lg:mt-0 lg:flex-row lg:space-y-0">
            <a class="transform text-gray-700 transition-colors duration-300 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 lg:mx-8" href="#">Accueil</a>
        ...
        <a class="mt-4 block rounded-lg bg-blue-600 px-6 py-2.5 text-center font-medium capitalize leading-5 text-white hover:bg-blue-500 lg:mt-0 lg:w-auto" href="#"> Démarer </a>
        </div>
    </nav>

    <div class="container mx-auto px-6 py-16 text-center">
        <div class="mx-auto max-w-lg">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white lg:text-4xl">Obtenez votre première adresse mail Professionnelle</h1>
        <p class="mt-6 text-gray-500 dark:text-gray-300">Dans les affaires ,l’e-mail professionnel est un gage de sérieux, un gain de sécurité pour vos données permettant aussi de centraliser les messageries électroniques.</p>
    ...
    <div class="h-[32rem] bg-gray-100 dark:bg-gray-800">
        <div class="container mx-auto px-6 py-10">
        <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">L'équipe dirigeante</h1>
        ...
        <p class="mx-auto mt-6 max-w-2xl text-center text-gray-500 dark:text-gray-300">Nous sommes une équipe jeune à votre service 24h/24 7J/7. Notre leitmotiv c'est de vous voir grandir et accomplir de grande chose. Parceque vous qui réussisez c'est nous qui grandissons .</p>
        </div>
    </div>
    ...
    <section class="bg-white dark:bg-gray-900">
    <div class="container mx-auto px-6 py-10">
        <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">Ce que disent les clients</h1>
    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <h1 class="text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">Articles de Blog </h1>

        <p class="mx-auto mt-4 max-w-lg text-gray-500">Apprenez en plus sur le monde très fermé des mails professionnel</p>
        </div>
        ...
        <div>
            ...
            <div class="absolute bottom-0 flex bg-white p-3 dark:bg-gray-900">
                ...
                <div class="mx-4">
                <h1 class="text-sm text-gray-700 dark:text-gray-200">Cédric H.</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Développeur</p>
                </div>
            </div>
            </div>

            <h1 class="mt-6 text-xl font-semibold text-gray-800 dark:text-white">Comment une adresse professionnelle renvoie vers le site Internet</h1>

            <hr class="my-6 w-32 text-blue-500" />

            <p class="text-sm text-gray-500 dark:text-gray-400">Fonctionner avec une adresse de messagerie électronique professionnelle revient à communiquer avec son nom de domaine.</p>

            <a href="#" class="mt-4 inline-block text-blue-500 underline hover:text-blue-400">lire plus</a>
        </div>
    ...
    <div class="container mx-auto px-6 py-8">
        <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">Nos tarifs</h1>

        <p class="mx-auto mt-4 max-w-2xl text-center text-gray-500 dark:text-gray-300 xl:mt-6">Profitez de tarifs très flexible et d'une équipe a votre écoute 24 heures / 24</p>
